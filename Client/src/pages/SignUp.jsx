...
const SignUp = () => {
  ...
  return (
    <div className="  flex font-roboto box-border ">
      ...
      <div className="bg-inherit h-screen text-black dark:text-gray-100 w-full flex flex-col sm:w-[633px] mx-auto p-4 pt-20  gap-5">
